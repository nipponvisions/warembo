...
<html>
	<head>
		...
		<meta name="viewport" content="width=device-width, innitial-scale=1.0, user-scalable=1.0">
	...
	<body>
		<div class="site_container">
			...
			<div class="below_header">
				...
				<center><h1>  The African Festival Queens  </h1></center>

					<ul class="models_container">

						<li>
							<img  src="images/diviner.jpg" Alt="diviner_pic">
						</li>
						<li>
						<img  src="images/ivy_two.jpg" alt="Ivytwo_pic">
						</li>
						<li>
							<img  src="images/diviner.jpg" Alt="diviner_pic">
						</li>
					...
					<div class= "models_thumbnails">

						<p> Hover on the Model for details </p>
						...
						<ul class="models">
							...
							<li>
							<a onclick="return false;"> <img src="Images/ivy_3_ppt.jpg" Alt="Ivy_3_ppt"><span>
							...
							<li>
							<a onclick="return false;"> <img src="Images/martha_4.jpg" alt="martha_4"><span>
							<img src="Images/martha_4.jpg" alt="martha_4"></span></a>
							</li>
							...
							<img src="Images/mary_martha.jpg" alt="mary_martha"></span></a>
							</li>
						</ul><!--models -->
			...
			<footer>
				<h2> New England Audio Visual Services </h2>
			</footer>
		</div><!-- site_container -->
	</body>
</html>
